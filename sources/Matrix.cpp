...
unsigned int Matrix::x() const {return xsize;}
unsigned int Matrix::y() const {return ysize;}
unsigned int Matrix::rows() const {return xsize;}
unsigned int Matrix::cols() const {return ysize;}
